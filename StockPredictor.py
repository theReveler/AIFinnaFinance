...
#
#startDate:     The start date as a string xx/xx/xxxx 
#endDate:       The end date as a string month/day/year
...
def PlotData(df, p = None):
    ...
    strTs = [datetime.fromtimestamp(i).strftime('%m/%y') for i in tickMarks]
    mpl.figure()
